---
title: "Welcome to the REDCap + R Workshop!"
format: html
editor: visual
---
...
In this next code chunk, we'll install all of the necessary packages for the workshop. This should take about one minute to complete.

```{r}
#| include: false

install.packages(c("rmarkdown", "tidyverse", "REDCapTidieR"))
...
The following two code chunks will use the **REDCapR** package to connect to a REDCap database and download its data into an object called `my_redcap_data`. Run the code chunks one after another.
